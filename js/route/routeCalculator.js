...
export const calculateOptimalRoute = (items, startPoint = null, options = {}) => {
...
export const getItemsForRoute = (mapData, region, categories, completedIds = new Set()) => {
...
export const findBoundaryStone = (mapData, region) => {
    ...
    const boundaryStone = mapData.items.find(item => {
        const itemRegion = item.forceRegion || item.region;
        return item.category === BOUNDARY_STONE_CATEGORY &&
