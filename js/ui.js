...
import { MAP_CONFIGS, usefulLinks, updateHistory, contributionLinks, guideSteps } from './config.js';
...
export const nextStep = () => {
    if (state.currentGuideStep < guideSteps.length - 1) {
        setState('currentGuideStep', state.currentGuideStep + 1);
        showStep(state.currentGuideStep);
    } else {
        closeGuide();
    }
};
